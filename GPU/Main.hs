...
main = do 
    ...
    fourier <- if isGPU 
                then aw_gridding GPU.run GPU.runN "data/SKA1_Low_wkern2.h5" "data/SKA1_Low_akern3.h5" "data/SKA1_Low_quick.h5" n_
                else aw_gridding CPU.run CPU.runN "data/SKA1_Low_wkern2.h5" "data/SKA1_Low_akern3.h5" "data/SKA1_Low_quick.h5" n_
